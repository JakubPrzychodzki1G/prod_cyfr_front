...
export default function Main(){
    ...
    return (
            <AnimatePresence>
                ...
                >
                    <BlogDiv image="https://images.unsplash.com/photo-1574744918163-6cef6f4a31b0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80" breadcrump="Zapisy!">
                        <div>
                            <div>
                            ...
                            <div className="flex justify-center w-full" onClick={()=>{setFormNumber(1)}}>
                                <BigButton classes="p-4 md:p-0 md:w-1/2 bg-blue-500 mt-10 mb-8">
                                    <span className="text-white min-[200px]:text-base min-[320px]:text-xl md:text-3xl">
