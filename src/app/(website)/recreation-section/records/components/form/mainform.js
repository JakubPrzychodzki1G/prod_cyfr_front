                    ...
                    <div className="bg-white rounded-lg shadow-lg p-4 px-4 md:p-8 mb-6">
                        <AnimatePresence>
                            ...
                            <div className="lg:col-span-2">
                                <div >
                                                                            <motion.div className={`${props.formId == 1 ? "grid" : "hidden"} gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 mb-4`} key={"FirstForm"} {...motionOptions}>
                                            <FirstForm toggleValidity={changeCountFormValid} changeForm={inputChangeHandler}/>
                                        </motion.div>
                                        <motion.div className={`${props.formId == 2 ? "grid" : "hidden"} gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 mb-4`} key={"SecondForm"} {...motionOptions}>
