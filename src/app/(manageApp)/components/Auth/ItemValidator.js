...
const rolesComponentsNamesMap = {
    ...
    "ROLE_COACH": [
        ...
        "lessonPlayers", // dziala
        "/activities", // dziala
        "/activities/edit", // dziala
        "/activities/new", // dziala
        "generateActivity", // dziala
    ],
    "ROLE_PLAYER": [
        "/grades",  // dziala
        "/lessons", // dziala
...
export const ItemValidator = (props) => {
    ...
    return (
        <>
            { rolesComponentsNamesMap[user.roles[0]].includes(props.permission) || rolesComponentsNamesMap[user.roles[0]] === "admin" ? props.children : <></> }
        </>
    )
}