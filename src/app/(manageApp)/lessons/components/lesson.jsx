        ...
        <>
            {
                ...
                : 
                <LessonData setLessonProperty={setLessonProperty} refresh={fetchLesson} coachesData={ coachesData } data={ data } isReadOnly={ readOnly } name={ readOnly ? "Lekcja" : "Edytuj Lekcje" }/>
            }
        </>
    )
}
