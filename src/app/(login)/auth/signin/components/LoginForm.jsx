...
import UseCountFormValid from "@/hooks/useCountFormValid"
import { redirect } from "next/navigation";

export default function LoginForm() {
    const [signInData, setSignInData] = useState({});

    const [countFormValid, changeCountFormValid] = UseCountFormValid();
    ...
    const onSubmitHandler = (event) => {
        ...
        if(countFormValid === 2){
            ...
            var raw = JSON.stringify(signInData);
        ...
        <form onSubmit={onSubmitHandler}>
            <div className="">
                <div className="relative">
                    ...
                    />
                    <span className="absolute right-4 top-13">
                        <svg
                ...
                <div className="mb-6">
                    <div className="relative">
                        ...
                        formIsValid={changeCountFormValid}
                        inputChange={inputChangeHandler}
                        errorText="Prosze podać odpowiednie hasło (hasło musi się składać z minimum 8 znaków)!"
                        />
