...
const Sidebar = ({ sidebarOpen, setSidebarOpen, className }) => {
  ...
  return auth ? (
    <aside
      ref={sidebar}
      className={`${className} z-9999 flex h-screen flex-col overflow-y-hidden bg-blue-500 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-slate-300 duration-300 ease-in-out hover:text-white ${pathname ===
                                "/" && "text-white"} `}
                            >
                              eCommerce
                            </Link>
              ...
              {/* <!-- Menu Item Players --> */}
              <ItemValidator permission="/players">
                <li>
                  <Link
                    href="/players"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes(
              ...
              <ItemValidator permission="/groups">
                <li>
                  <Link
                    href="/groups"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes(
              ...
              <ItemValidator permission="/lessons">
                <li>
                  <Link
                    href="/lessons"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes(
              ...
              <ItemValidator permission="/grades">
                <li>
                  <Link
                    href="/grades"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes(
              ...
              <ItemValidator permission="/activities">
                <li>
                  <Link
                    href="/activities"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes(
              ...
              {/* <!-- Menu Item Settings --> */}
              <ItemValidator permission="/system">
                <li>
                  <Link
                    href="/system"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes(
